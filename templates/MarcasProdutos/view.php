...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Marcas Produto'), ['action' => 'edit', $marcasProduto->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Marcas Produto'), ['action' => 'delete', $marcasProduto->id], ['confirm' => __('Are you sure you want to delete # {0}?', $marcasProduto->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Marcas Produtos'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Marcas Produto'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="marcasProdutos view content">
            <h3><?= h($marcasProduto->id) ?></h3>
            <table>
                <tr>
                    <th><?= __('Nome Marca') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($marcasProduto->produtos)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($marcasProduto->produtos as $produtos) : ?>
                        <tr>
                            <td><?= h($produtos->id) ?></td>
